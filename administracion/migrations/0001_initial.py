    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FECHA_ENTREGA', models.DateField(blank=True, default=datetime.date.today, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('CODIGO', models.AutoField(primary_key=True, serialize=False)),
                ('ESTADO', models.CharField(blank=True, choices=[('Pendiente', 'Pendiente'), ('Aceptado', 'Aceptado'), ('Entregado', 'Entregado')], default='Pendiente', max_length=20, null=True)),
                ('FECHA_ENTREGA', models.DateField(blank=True, null=True)),
                ('PRECIO_VENTA', models.DecimalField(blank=True, decimal_places=2, default=1, max_digits=22, null=True)),
                ('COSTO_FINAL', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=22, null=True)),
                ('VALIDO_HASTA', models.DateField(blank=True, default=datetime.date(2023, 8, 27), null=True)),
                ('ULTIMA_ACTUALIZACION', models.DateTimeField(auto_now=True, null=True)),
                ('ARTICULOS', models.TextField(blank=True, null=True)),
                ('GASTOS_ADICIONALES', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=22, null=True, verbose_name='TOTAL ADICIONALES')),
                ('ARTICULOS_INCLUIDOS', models.ManyToManyField(to='administracion.receta')),
                ('CLIENTE', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='administracion.cliente')),
            ],
            options={
